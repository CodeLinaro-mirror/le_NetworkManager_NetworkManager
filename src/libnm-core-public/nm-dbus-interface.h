 ...
 *   quitting. Since: 1.48
 * @NM_DEVICE_STATE_REASON_UNMANAGED_SLEEPING: Use %NM_DEVICE_STATE_REASON_UNMANAGED_MANAGER_DISABLED
 *   instead. Since: 1.48
 ...
 * @NM_DEVICE_STATE_REASON_NETWORKING_OFF: NetworkManager was disabled (networking off)
 *
