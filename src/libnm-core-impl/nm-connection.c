...
_normalize_wireless_mac_address_randomization(NMSettingWireless *s_wifi)
{
    ...
    /* Note that "desired_cloned_mac_address" is possibly the string owned by s_wifi.
     * There is a small danger with self-assignment here (but it's handled correctly). */
