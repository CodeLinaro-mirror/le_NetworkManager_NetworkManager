 ...
 * GObject property. This is the prefered way to define enum properties because using
...
#define _nm_setting_property_is_valid_direct_enum(property_info)                               \
    ({                                                                                         \
        ...
        GType                     direct_gtype   = _property_info->direct_enum_gtype;          \
        GType                     spec_gtype     = _property_info->param_spec->value_type;     \
                                                                                               \
