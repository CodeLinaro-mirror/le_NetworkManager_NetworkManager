...
test_config_managed(void)
{
    ...
    g_assert_cmpstr(g_key_file_get_value(kf, group_by_name, "managed", NULL), ==, "1");
    g_assert_cmpstr(g_key_file_get_value(kf, group_by_mac, "managed", NULL), ==, NULL);
    ...
    g_key_file_load_from_file(kf, CONFIG_INTERN, G_KEY_FILE_NONE, NULL);
    g_assert_cmpstr(g_key_file_get_value(kf, group_by_name, "managed", NULL), ==, "0");
    g_assert_cmpstr(g_key_file_get_value(kf, group_by_mac, "managed", NULL), ==, NULL);
    ...
    g_assert_cmpint(managed, ==, NM_TERNARY_TRUE);
    g_key_file_load_from_file(kf, CONFIG_INTERN, G_KEY_FILE_NONE, NULL);
    g_assert_cmpstr(g_key_file_get_value(kf, group_by_name, "managed", NULL), ==, NULL);
    g_assert_cmpstr(g_key_file_get_value(kf, group_by_mac, "managed", NULL), ==, "1");
    ...
    g_key_file_load_from_file(kf, CONFIG_INTERN, G_KEY_FILE_NONE, NULL);
    g_assert_cmpstr(g_key_file_get_value(kf, group_by_name, "managed", NULL), ==, NULL);
    g_assert_cmpstr(g_key_file_get_value(kf, group_by_mac, "managed", NULL), ==, "0");
