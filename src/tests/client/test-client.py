...
class TestNmCloudSetup(TestNmClient):
    ...
    def test_aliyun(self):
        ...
        self._mock_path(_aliyun_macs + TestNmCloudSetup._mac2 + "/vpc-cidr-block", "172.31.16.0/20")
        self._mock_path(_aliyun_macs + TestNmCloudSetup._mac2 + "/private-ipv4s", TestNmCloudSetup._ip1)
        self._mock_path(_aliyun_macs + TestNmCloudSetup._mac2 + "/primary-ip-address", TestNmCloudSetup._ip1)
        self._mock_path(_aliyun_macs + TestNmCloudSetup._mac2 + "/netmask", "255.255.255.0")
        self._mock_path(_aliyun_macs + TestNmCloudSetup._mac2 + "/gateway", "172.31.26.2")
        self._mock_path(_aliyun_macs + TestNmCloudSetup._mac1 + "/vpc-cidr-block", "172.31.166.0/20")
        self._mock_path(_aliyun_macs + TestNmCloudSetup._mac1 + "/private-ipv4s", TestNmCloudSetup._ip2)
        self._mock_path(_aliyun_macs + TestNmCloudSetup._mac1 + "/primary-ip-address", TestNmCloudSetup._ip2)
        self._mock_path(_aliyun_macs + TestNmCloudSetup._mac1 + "/netmask", "255.255.255.0")
        self._mock_path(_aliyun_macs + TestNmCloudSetup._mac1 + "/gateway", "172.31.176.2")
    ...
    def test_azure(self):
        ...
        self._mock_path(_azure_iface + "0/macAddress" + _azure_query, TestNmCloudSetup._mac1)
        self._mock_path(_azure_iface + "1/macAddress" + _azure_query, TestNmCloudSetup._mac2)
        self._mock_path(_azure_iface + "0/ipv4/ipAddress/" + _azure_query, "0\n")
        self._mock_path(_azure_iface + "1/ipv4/ipAddress/" + _azure_query, "0\n")
        self._mock_path(_azure_iface + "0/ipv4/ipAddress/0/privateIpAddress" + _azure_query, TestNmCloudSetup._ip1)
        self._mock_path(_azure_iface + "1/ipv4/ipAddress/0/privateIpAddress" + _azure_query, TestNmCloudSetup._ip2)
        self._mock_path(_azure_iface + "0/ipv4/subnet/0/address/" + _azure_query, "172.31.16.0")
        self._mock_path(_azure_iface + "1/ipv4/subnet/0/address/" + _azure_query, "172.31.166.0")
        ...
        nmc.pexp.expect("interface\[0]: received subnet address")
        nmc.pexp.expect("interface\[0]: received subnet prefix 20")
        nmc.pexp.expect("get-config: success")
        nmc.pexp.expect("meta data received")
        # One of the devices has no IPv4 configuration to be modified
        nmc.pexp.expect("device has no suitable applied connection. Skip")
