...
class Device(ExportedObj):
    ...
    def start(self):
        ...
        if Util.random_int(self.path, 100) > 80:
            self.ip4_config._dbus_property_set(IFACE_IP4_CONFIG,
                                               PRP_IP4_CONFIG_CLAT_ADDRESS,
                                               "192.0.0.1");
            self.ip6_config._dbus_property_set(IFACE_IP6_CONFIG,
                                               PRP_IP6_CONFIG_CLAT_ADDRESS,
                                               "2002:aaaa::2c0d:1e71:ef87:fac7");
            self.ip6_config._dbus_property_set(IFACE_IP6_CONFIG,
                                               PRP_IP6_CONFIG_CLAT_PREF64,
                                               "64:ff9b::/96");
